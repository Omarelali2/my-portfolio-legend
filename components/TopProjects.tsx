...
const projects: Project[] = [
  {
    name: "Samsung Clone",
    description:
      "Full‑stack Samsung store (demo project – desktop only).",
    stack: [
      "React",
      "Node.js",
      "Express",
  ...
  return (
    <section className="bg-gradient-to-br from-slate-950 via-indigo-950 to-black py-24 px-6">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-center text-5xl font-extrabold mb-20 text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500">
          Selected Projects
        </h2>
